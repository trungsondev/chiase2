    ...
    public partial class QLDTContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<LopHpSinhVien>(entity =>
            {
                ...
                entity.Property(e => e.LopHPSVID).HasColumnName("LopHPSVID");
                entity.Property(e => e.SinhVienId).HasColumnName("SinhVienID");
                entity.Property(e => e.DiemChu).HasColumnName("DiemChu");
                entity.Property(e => e.DiemGK).HasColumnName("DiemGK");
                entity.Property(e => e.LanHoc).HasColumnName("LanHoc");
                entity.Property(e => e.HeSo4).HasColumnName("HeSo4");
                entity.Property(e => e.LopHpLTid).HasColumnName("LopHpLTid");
                entity.Property(e => e.LopHpTHid).HasColumnName("LopHpTHid");
